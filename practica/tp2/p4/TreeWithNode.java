...
public class TreeWithNode {
    ...
    public TreeWithNode(int k) {
        this.root = null;
        this.k = k;
    }

    public void fillValues() {
        this.fillValues(this.root);
    }

    private Integer fillValues(TreeNode nodo_actual) {
        if (nodo_actual != null) {
            Integer valor_nodo = nodo_actual.getValue();
            Integer valor_izquierda = null;
            Integer valor_derecha = null;
            ...
            if (valor_nodo == null) {
                ...
                if (nodo_izquierda == null) {
                    ...
                    valor_izquierda = nodo_izquierda.getValue();
                    if (valor_izquierda == null) {
                        valor_izquierda = this.fillValues(nodo_izquierda);
                    }
                }
                ...
                if (nodo_derecha == null) {
                    ...
                    valor_derecha = nodo_derecha.getValue();
                    if (valor_derecha == null) {
                        valor_derecha = this.fillValues(nodo_derecha);
                    }
                }
                valor_nodo = valor_derecha - valor_izquierda;
                nodo_actual.setValue(valor_nodo);
            }
        }
    ...
    /* public boolean setNull(Integer value) {
        return this.setNull(this.root, value);
    }

    private boolean setNull(TreeNode nodo_actual, int value) {
        if (nodo_actual != null) {
            Integer nodo_valor = nodo_actual.getValue();

            if (nodo_valor == null) {
                boolean resultado = this.setNull(nodo_actual.getLeft(), value);
                if (!resultado) {
                    return this.setNull(nodo_actual.getRight(), value);
                }
                return resultado;
            }

            if (nodo_valor > value) {
                return this.setNull(nodo_actual.getLeft(), value);
            } else if (nodo_valor < value) {
                return this.setNull(nodo_actual.getRight(), value);
            } else {
                nodo_actual.setValue(null);
                return true;
            }
        }
        return false;
    ...
    public List<Integer> getExternalNodesHigherThanK() {
        ArrayList<Integer> external_nodes = new ArrayList<>();
        this.getExternalNodesHigherThanK(this.root, external_nodes);
        return external_nodes;
    }

    private void getExternalNodesHigherThanK(TreeNode nodo_actual, List<Integer> external_nodes) {
        if (nodo_actual != null) {
            if (nodo_actual.getLeft() == null && nodo_actual.getRight() == null) {
                Integer valor_nodo = nodo_actual.getValue();

                if (valor_nodo > this.k) {
                    external_nodes.add(valor_nodo);
                }
            }
            this.getExternalNodesHigherThanK(nodo_actual.getLeft(), external_nodes);
            this.getExternalNodesHigherThanK(nodo_actual.getRight(), external_nodes);
        }
    }
