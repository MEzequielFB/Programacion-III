...
public class Main {
    public static void main(String[] args) {
        ...
        ServicioAsignacion servicio = new ServicioAsignacion(procesadores, tareas);
        System.out.println("Solucion: " + servicio.asignarTareas());
        System.out.println("Solucion tiempo de ejecucion: " + servicio.getSolucionTiempoEjecucion());
    }
}