...
public class Pila implements Iterable<Object> {
    ...
    //Recorrerse no deberia ser responsabilidad de la Pila. Para eso se usan iteradores externos para tener multiples cursores
    @Override
